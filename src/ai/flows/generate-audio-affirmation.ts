...
const generateAudioAffirmationFlow = ai.defineFlow(
    {
        name: 'generateAudioAffirmation',
        inputSchema: GenerateAudioAffirmationInputSchema,
        outputSchema: GenerateAudioAffirmationOutputSchema,
    },
    async (input) => {
        const prompt = `You are an expert in positive psychology and a compassionate guide. Write a short, uplifting audio affirmation script of about 200 words.
